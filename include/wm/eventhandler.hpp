...
namespace wm
{
	...
	*/
	...
	inline void EventHandler::handle(const ExposeEvent&) { }
	inline void EventHandler::handle(const ButtonEvent&) { }
	inline void EventHandler::handle(const KeyEvent&) { }
	inline void EventHandler::handle(const FocusEvent&) { }
	inline void EventHandler::handle(const MouseOverEvent&) { }
	inline void EventHandler::handle(const ResizeEvent&) { }
	inline void EventHandler::handle(const ShowEvent&) { }
	inline void EventHandler::handle(const CloseEvent&) { }
	inline void EventHandler::handle(const CharacterEvent&) { }
	inline void EventHandler::handle(const MotionEvent&) { }
}
